            ...
            <div className={classes.subConatiner}>
                <div className={classes.leftContainer}>
                    <div className={classes.Internship}>
                        ...
                        <p className={classes.des}>I worked here for more than 3 months . It was a very wonderful experiece . I got to convert wireframes into designs and some amazing prjeicts</p>
                    </div>
                    ...
                    <div className={classes.OtherDetails}>
                        ...
                        <p className={classes.des} style={{paddingTop:"12px"}}>I worked here for more than 3 months . It was a very wonderful experiece . I got to convert wireframes into designs and some amazing prjeicts</p>
                    </div> 
                </div>
